...
export class EditGroupComponent implements OnInit {
  ...
  isEditing = !!this.data;
  title = this.isEditing ? 'Modification de ' + this.data.id : 'Ajouter un cours group';
  possibleUsers = [{firstName: 'Samuel', LastName: 'Leclerc'}, {firstName: 'Nicolas', LastName: 'Charland'}];
  loaded = false;
  constructor(
